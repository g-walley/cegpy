...
class CegUtil:
	...
	def create_sampling_zeros(sampling_zero_paths, path_dict) -> defaultdict:
		'''The list of paths to zero must only contain tuples. Each tuple is a sampling zero path
		...
		et = ceg({'dataframe': df, 'sampling_zero_paths': [('eat', 'sleep',),('eat', 'sleep','repeat',)]})
		'''	
